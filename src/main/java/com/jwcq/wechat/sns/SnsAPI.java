package com.jwcq.wechat.sns;

import java.io.UnsupportedEncodingException;
import java.net.URLEncoder;

import com.jwcq.wechat.API;
import com.jwcq.wechat.bean.Jscode2sessionResult;
import com.jwcq.wechat.bean.SnsToken;
import org.apache.http.client.methods.HttpUriRequest;
import org.apache.http.client.methods.RequestBuilder;

import com.jwcq.wechat.bean.BaseResult;
import com.jwcq.wechat.LocalHttpClient;
...
public class SnsAPI extends BaseAPI {
    ...
    public static UserWechat userinfo(String access_token, String openid, String lang) {
        return userinfo(access_token, openid, lang, 5);
    }
